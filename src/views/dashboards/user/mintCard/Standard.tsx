...
const MintStandardCard = () => {
  ...
  const { config, isError: isPrepareContractError } = usePrepareContractWrite({
    ...
    abi: CONTRACT_ABI,
    functionName: 'mintStandardLands',
  ...
  useEffect(() => {
    const checkProgress = async () => {
      const progress = (await readContract({
        ...
        args: ['0', (auth.user as UserDataType).address],
  ...
  return (
    <Card sx={{ position: 'relative' }}>
      ...
      <CardContent>
        ...
        <LinearProgress value={mintedCount / 4050} color='success' sx={{ mb: 5.75 }} variant='determinate' />
...
export default MintStandardCard
